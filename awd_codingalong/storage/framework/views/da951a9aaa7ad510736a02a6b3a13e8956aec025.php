<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="jumbotron">
            ...
            <a class="btn btn-primary btn-lg" href="<?php echo e(route('item', ['id' => 1])); ?>" role="button">Details</a>
        </div>
        <div class="jumbotron">
            ...
            <a class="btn btn-primary btn-lg" href="<?php echo e(route('item', ['id' => 2])); ?>" role="button">Details</a>
        </div>
        <div class="jumbotron">
            ...
            <a class="btn btn-primary btn-lg" href="<?php echo e(route('item', ['id' => 3])); ?>" role="button">Details</a>
        </div>
    </div>
